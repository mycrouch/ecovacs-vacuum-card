    ...
    this.innerHTML = `
      <ha-card>
        <style>
          ...
          .robot-image { width: 180px; height: 180px; }
          .robot-image.cleaning { animation: robot-spin 3s linear infinite; }
          .robot-image.returning { animation: robot-pulse 1.2s ease-in-out infinite; }
          @keyframes robot-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
          @keyframes robot-pulse { 0%, 100% { transform: scale(1); } 50% { transform: scale(0.94); } }
